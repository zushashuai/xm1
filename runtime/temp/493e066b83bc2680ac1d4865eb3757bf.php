<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"E:\phpStudy\WWW\tp5\public/../app/admin\view\admin\edit.html";i:1513650117;s:61:"E:\phpStudy\WWW\tp5\public/../app/admin\view\public\base.html";i:1513754481;}*/ ?>
<!doctype html>
<html>
        ...
        <div class="tpl-block ">
            <div class="am-g tpl-amazeui-form">
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" action="<?php echo url('Admin/update'); ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $res['id']; ?>">
                        <input type="hidden" name="oldpicname" value="<?php echo $res['picname']; ?>">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">账号</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="username" name="username" placeholder="账号" value="<?php echo $res['username']; ?>">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="name" name="name" placeholder="姓名" value="<?php echo $res['name']; ?>">
                                <small style="display:inline-block;"></small>
                            </div>
                        </div>
