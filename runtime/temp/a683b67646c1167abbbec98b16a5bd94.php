<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\phpStudy\WWW\tp5\public/../app/admin\view\login\login.html";i:1513064860;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function changeCode(){
    ...
    $("#captcha_img").attr("src", "<?php echo captcha_src(); ?>?t="+ (new Date().getTime()));
}
//换背景
function choose_bg() {
...
<div class="container">
    <div class="main_box">
        ...
        <form action="<?php echo url('login/logincheck'); ?>" id="login_form" method="post">
